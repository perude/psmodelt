...
import pl.sap.customsite.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		definitonFactory.add("classpath:/customsitefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/customsitefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/customsitefulfilmentprocess/test/testCatalog.csv", "windows-1252");
