 ...
 */
package pl.sap.customsite.core.constants;

/**
 * Global class for all CustomsiteCore constants. You can add global constants for your extension into this class.
 */
public final class CustomsiteCoreConstants extends GeneratedCustomsiteCoreConstants
{
	public static final String EXTENSIONNAME = "customsitecore";


	private CustomsiteCoreConstants()
	{
		//empty
	}
