 ...
 */
package pl.support.custstorefront.fulfilmentprocess.test.jobs;
...
import pl.support.custstorefront.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CuststorefrontFulfilmentProcessConstants.ORDER_PROCESS_NAME;
