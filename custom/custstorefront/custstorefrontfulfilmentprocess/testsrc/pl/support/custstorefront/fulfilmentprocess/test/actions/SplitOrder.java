 ...
 */
package pl.support.custstorefront.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CuststorefrontFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CuststorefrontFulfilmentProcessConstants.PARENT_PROCESS);
