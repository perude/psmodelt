 ...
 */
package pl.support.custstorefront.test.setup;
...
import pl.support.custstorefront.test.constants.CuststorefrontTestConstants;
import pl.support.custstorefront.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CuststorefrontTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/custstorefronttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/custstorefronttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/custstorefronttest/import/cstickets.impex");
			...
			importImpexFile(context, "/custstorefronttest/import/csquotes.impex");
		}
	}
}
