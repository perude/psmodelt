 ...
 */
package pl.support.custstorefront.core.suggestion;
...
import pl.support.custstorefront.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/custstorefrontcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
