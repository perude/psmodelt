 ...
 */
package pl.support.custstorefront.core.constants;

/**
 * Global class for all CuststorefrontCore constants. You can add global constants for your extension into this class.
 */
public final class CuststorefrontCoreConstants extends GeneratedCuststorefrontCoreConstants
{
	public static final String EXTENSIONNAME = "custstorefrontcore";


	private CuststorefrontCoreConstants()
	{
		//empty
	}
